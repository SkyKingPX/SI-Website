    ...
    return (
        <main className="min-h-screen">
            ...
            <motion.section id="socials" className={`py-10 md:py-22 relative overflow-hidden ${sectionTopSpacing}`}>
                {/* Background Elements */}
                <div className="absolute inset-0 -z-10">
                    <div className="absolute top-1/3 left-1/4 w-64 h-64 bg-primary/70 rounded-full blur-3xl opacity-30 animate-pulse-slow"/>
                    <div className="absolute bottom-1/4 right-1/3 w-72 h-72 bg-secondary/60 rounded-full blur-3xl opacity-25 animate-pulse-slow"/>
                </div>
                                ...
                                <CardFooter>
                                    <Button asChild>
                                        <a href={`${LINKS.discord}`} target="_blank" rel="noopener noreferrer">
                                            Join Server <ArrowRight size={16} className="ml-2"/>
                                        </a>
                                    </Button>
                                </CardFooter>
                            </Card>
                                ...
                                <CardFooter>
                                    <Button asChild>
                                        <a href={`${LINKS.tiktok}`} target="_blank" rel="noopener noreferrer">
                                            Follow <ArrowRight size={16} className="ml-2"/>
                                        </a>
                                    </Button>
                                </CardFooter>
                            </Card>
                            ...
                            <Card className="hover-scale h-full border-border/50">
                                <CardHeader>
                                    <div className="w-12 h-12 rounded-full bg-[#181717]/10 flex items-center justify-center mb-4">
                                        <img src="/assets/github.svg" alt="GitHub" className={`${theme === 'dark' ? 'invert' : ''} h-6 w-6`}/>
                                    </div>
                                ...
                                <CardFooter>
                                    <Button asChild>
                                        <a href={`${LINKS.modrinth_org}`} target="_blank" rel="noopener noreferrer">
                                            Visit Profile <ArrowRight size={16} className="ml-2"/>
                                        </a>
                                    </Button>
                                </CardFooter>
                            </Card>
                            ...
                            <Card className="hover-scale h-full border-border/50">
                                <CardHeader>
                                    <div className="w-12 h-12 rounded-full bg-[#F16436]/10 flex items-center justify-center mb-4">
                                        <img src="/assets/curseforge.svg" alt="CurseForge" className={`${theme === 'dark' ? 'invert' : ''} h-6 w-6`}/>
                                    </div>
